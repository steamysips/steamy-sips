...
<!--loading animation from starbucks.com-->
<main class="container">
    <div style="margin-top: 50px">
        <svg viewBox="0 0 73 85" role="img" id="skeleton-loadingCoffeeCup">
            <g>
                <path stroke="currentColor" strokewidth="2.908" strokelinecap="round" strokelinejoin="round"
                      fill="currentColor"
                      d="M53.8 38.6c-2-4-9.6-7.2-17.6-7.2-8 0-15.2 3.2-17.6 7.2 0 0 3.6 8 18.4 8 13.6-.4 16.8-8 16.8-8z"></path>
                ...
                <path id="skeleton-loadingCoffeeSteam" stroke="currentColor" fill="none" strokewidth="2"
                      strokelinecap="round" strokelinejoin="round"
                      d="M31 26.333c0-2.89 4.063-2.89 4.063-5.777 0-2.89-4.063-2.89-4.063-5.778 0-2.89 4.063-2.89 4.063-5.778M38 26.333c0-2.89 4.063-2.89 4.063-5.777 0-2.89-4.063-2.89-4.063-5.778 0-2.89 4.063-2.89 4.063-5.778"></path>
            </g>
        </svg>
    </div>
</main>