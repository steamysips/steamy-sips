...
| Attribute        | Description                       | Data Type       | Constraints                                    |
|----------------- |---------------------------        |-----------------|------------------------------------------      |
| order_id         | ID of user who placed order       | INTEGER         | PRIMARY KEY, auto-increment                    |
...
| Attribute          | Description                     | Data Type     | Constraints                                                 |
|-----------------   |---------------------------      |---------------|-------------------------------------------------------------|
| order_id           | ID of user who placed order     | INTEGER       | PRIMARY KEY, FOREIGN KEY REFERENCES order(order_id)         |
